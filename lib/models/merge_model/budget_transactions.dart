...
class BudgetTransactionsModel{
  ...
  List<BudgetTransactionsModel> toList(List<BudgetModel> budgets, List<TransactionModel> transactions){
    ...
    for (var budget in budgets) {
      ...
      final model = BudgetTransactionsModel(budget: budget, transactions: transactionsOfBudget);
      list.add(model);
    }
    return list;
  }
