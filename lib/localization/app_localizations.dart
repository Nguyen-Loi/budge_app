...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Welecome to Budget Application!'**
  ...
  /// No description provided for @spendLimitPerMonth.
  ///
  /// In en, this message translates to:
  /// **'Spend limit per Month'**
  String get spendLimitPerMonth;
  ...
  /// No description provided for @financesGood.
  ///
  /// In en, this message translates to:
  /// **'Your finances are looking good'**
  String get financesGood;
  ...
  /// No description provided for @pUserJoinDescriptions.
  ///
  /// In en, this message translates to:
  /// **'You joined ViNho on {dateTime}. It\'s been {numberMonth} month since then and our mission is still the same and help you better manage your money'**
  ...
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =0{Forgot} =1{ password?} other{{count} errorText}}'**
  ...
  /// No description provided for @operatingPeriod.
  ///
  /// In en, this message translates to:
  /// **'Operating period'**
  String get operatingPeriod;
  ...
  ///
  /// In en, this message translates to:
  /// **'Start tracking your income to ensure you\'re meeting your financial goals.'**
  String get startIncome;

  /// No description provided for @processIncome.
  ///
  /// In en, this message translates to:
  /// **'Your income is steady. Keep aiming for your financial goals.'**
  String get processIncome;

  /// No description provided for @almostDoneIncome.
  ///
  /// In en, this message translates to:
  /// **'You\'re close to hitting your income goal. Keep it up!'**
  String get almostDoneIncome;

  /// No description provided for @completeIncome.
  ///
  /// In en, this message translates to:
  /// **'Excellent! You\'ve met or exceeded your income goal.'**
  String get completeIncome;

  /// No description provided for @startExpense.
  ///
  /// In en, this message translates to:
  /// **'Start tracking your expenses to avoid exceeding your budget.'**
  String get startExpense;

  /// No description provided for @processExpense.
  ///
  /// In en, this message translates to:
  /// **'Your expenses are under control. Keep managing them carefully!'**
  String get processExpense;

  /// No description provided for @almostDoneExpense.
  ///
  /// In en, this message translates to:
  /// **'You\'re almost done with your spending goal. Don’t forget to stay under the limit!'**
  String get almostDoneExpense;

  /// No description provided for @completeExpense.
  ///
  /// In en, this message translates to:
  /// **'Attention, your budget has reached its limit!'**
