...
class GoalData {
  static List<GoalModel> listItem = [
    GoalModel({
      FieldConstants.name: 'Shopping1',
      FieldConstants.iconId: 11,
    ...
    GoalModel({
      ...
      FieldConstants.iconId: 14,
      FieldConstants.limit: 400,
      FieldConstants.currentAmount: 200,
      TableConstant.goalTransaction: []
    }),
    GoalModel({
      FieldConstants.name: 'Shopping 55',
      FieldConstants.iconId: 15,
      FieldConstants.limit: 500,
      FieldConstants.currentAmount: 200,
      TableConstant.goalTransaction: []
    }),
    GoalModel({
      FieldConstants.name: 'Shopping Pro',
      FieldConstants.iconId: 11,
      FieldConstants.limit: 300,
      FieldConstants.currentAmount: 200,
      TableConstant.goalTransaction: [
